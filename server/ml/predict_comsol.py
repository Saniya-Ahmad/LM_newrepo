...
MODEL_PATH = f"ml/models/xgb_{period.lower()}_peak_comsol.pkl"
ENCODER_PATH = f"ml/models/{period.lower()}_encoder_comsol.pkl"
METRICS_PATH = f"ml/models/{period.lower()}_metrics_comsol.json"

TABLE_MAP = {
    "Daily": "daily_comsol_features",
    "Weekly": "weekly_comsol_features",
    "Monthly": "monthly_comsol_features",
}
