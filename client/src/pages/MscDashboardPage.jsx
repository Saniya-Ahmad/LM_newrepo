...
export default function MscDashboardPage() {
    ...
    <div className="space-y-8 text-slate-900 dark:text-white">
      <div className="rounded-3xl border p-6 shadow-xl bg-white border-slate-200 dark:bg-slate-950 dark:border-slate-800">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold">MSC Dashboard</h1>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
              MSC license analytics adapted to the website dashboard experience.
            </p>
          </div>
